...
installation can be done using the \code{brew install gmp}
command.

\medskip

On Linux systems, after downloading the file, a simple
\code{./configure} and then \code{make install} will install
GMP.
...
build the included file call \code{tune} as a preliminary
