...
\codestt{\lstinputlisting{../../../src/party/receiver.pr}}

File \public{\bobdemo}:
\codestt{\lstinputlisting{../../../src/party/receiver.pu}}
...
\codestt{\lstinputlisting{../../../src/party/sender.pr}}

Shell input: \encryptindemo
Shell output: \encryptoutdemo

File \public{\alicedemo}:
\codestt{\lstinputlisting{../../../src/party/sender.pu}}
