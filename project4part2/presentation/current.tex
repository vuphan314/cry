...
Padding is a technique to make a string equal in length to
the key size. If this were not so, the security of block
ciphers would be compromised.
However, in our case our padding function simply converts
a string type to an integer type.
